...
print("Program To train a base CNN for CIFAR10")
...
# can we initialize the model with higher values of weights    
# for nm, params in model.named_parameters():
#     if "weight" in nm and "bn" not in nm and "linear" not in nm:
#         with torch.no_grad():
#             torch.nn.init.uniform(params.data,a=0.9,b=1)
#             break
...
history2, weight_description=fit(epochs, lr, model, train_loader, val_loader, 
        weight_description=weight_description,model_state_path=model_state_path)



pickle.dump(weight_description, open( "pickles/weight_description_CNN_05_1_100.p", "wb" ) )
...
print("Compression=",compression,"Result after training is ",res,"Going for re training")
