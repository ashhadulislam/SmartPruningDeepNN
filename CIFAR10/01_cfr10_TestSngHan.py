...
df_base=pd.read_csv("results_sheet/mod_CNN_05_1_100_song_hn.csv")
...
for prune_rate in prune_rate_range:
    ...
    epochs=30
    pruned_model_state_path="model_state/song_han_mod_CNN_05_1_100.pt"
    ...
    print("Pruning+Re training the songhan way, complete")
#     if torch.cuda.is_available():
...
dataframe_results.to_csv("results_sheet/mod_CNN_05_1_100_song_hn.csv",
                         index=False)
