...
print("Program To apply beizier on mean weight on CIFAR10, slowly changing upscale")
...
for range_params in range_params_list:
    ...
    for upscale in upscale_list:
        ...
        while i<turns:
            print(i,"/",turns,"upscale = ",upscale,"epochs=",epochs)
...
print(df.head())
df.to_csv(os.path.join("results_sheet","bezier_metrics_meanWts_slowProgression.csv"),index=False)        
