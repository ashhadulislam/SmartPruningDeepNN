...
df_base=pd.read_csv("results_sheet/py_mean_weighted.csv")
...
prune_rate_range=[0.1,0.3,0.6,0.9,1.3,
                  1.92,1.95,2.1,2.2,
                 2.25,2.35,2.4,2.5,2.7,2.9,4]
...
dataframe_results.to_csv("results_sheet/py_mean_weighted.csv",
                         index=False)