...
if os.path.isfile(os.path.join("results_sheet","04bezier_on_actl_Wts18Jan2021.csv")):
    df_base=pd.read_csv(os.path.join("results_sheet","04bezier_on_actl_Wts18Jan2021.csv"))
    df_concat=pd.concat([df_base,df])
    df=df_concat

df.to_csv(os.path.join("results_sheet","04bezier_on_actl_Wts18Jan2021.csv"),index=False)