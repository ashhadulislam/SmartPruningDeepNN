...
print("Program running, 03_BeizierOnMean.py")
...
#             model_state_path="model_state/mod.pt"
            model_state_path="model_state/03_bez_on_mean/[0.81, 0.81, 0.81, 0.71]/0.2/+/1704.pt"
            mask_path="pickles/masks/03_bez_on_mean/[0.81, 0.81, 0.81, 0.71]/0.2/+/1704.pkl"
...
#             list_mask_whole_model=prune_mean_weights_get_mask_bezier(model,range_params,upscale,
#                                             mean_weight_description_weighted, upscale_method)
            ...
            print("Originally, Compression=",compression,"Result after pruning is ",res)
            ...
            while i<turns:
                ...
                if os.path.isfile(this_turn_model_state_path):
                    ...
                    print("Compression=",compression,
                          "Result after re training is ",res,"Going for re training")
...
#file already exists
if os.path.isfile(os.path.join("results_sheet","03_bezier_on_mean_pers_18JanTry.csv")):
    df_base=pd.read_csv(os.path.join("results_sheet","03_bezier_on_mean_pers_18JanTry.csv"))
    df_concat=pd.concat([df_base,df])
    df=df_concat

df.to_csv(os.path.join("results_sheet","03_bezier_on_mean_pers_18JanTry.csv"),index=False)        
