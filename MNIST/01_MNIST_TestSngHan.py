...
print("Song Han MNIST Program, 01_MNIST_TestSngHan.py")
...
df_base=pd.read_csv("results_sheet/01_song_hn.csv")
done_pruning_list=list(df_base["prune_rate"])



# prune_rate_range=[0.05,0.1,0.3,0.4,0.6,0.8,1.1,1.3,1.5,1.7,
#                   1.8,2.1,2.2,2.4,2.6,2.8,2.9,3.1,3.15,3.12,3.22,3.29,3.35,3.4,3.45,3.5,3.55,
#                   3.6,3.65,3.7,3.75,3.8,3.85,3.9,3.95,4,4.25,4.5,5,6]


prune_rate_range=[0.05,0.1,1.1,1.5,1.7,2.2,2.4,
                  2.8,3.15,
                  3.29,3.33,3.4,3.45,3.65,3.7,3.75,3.9,4.2,4.5,5.2,5.8,6]
...
#     print("Mask compression = ",prune_rate,get_mask_compression(mask_whole_model))
    ...
    epochs=30
    pruned_model_state_path="model_state/01_song_han_mod_CNN.pt"
...
dataframe_results.to_csv("results_sheet/01_song_hn.csv",
                         index=False)
